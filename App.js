  ...
  return (
    <div className="App">
      ...
      <section className="about-us">
        <h2>About Us</h2>
        <p>Our mission is to provide quality childcare that meets the needs of each child and family.</p>
      ...
      <section className="programs">
        ...
        <div className="program">
          <h3>Infant Care</h3>
          <p>Our infant care program provides a nurturing environment for your baby.</p>
        </div>
        <div className="program">
          <h3>Toddler Program</h3>
          <p>Our toddler program encourages exploration and learning through play.</p>
        </div>
        <div className="program">
          <h3>Preschool</h3>
          <p>Our preschool program prepares children for kindergarten and beyond.</p>
        </div>
      </section>
